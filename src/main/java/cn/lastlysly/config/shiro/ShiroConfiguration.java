...
import cn.lastlysly.myutils.shiro.MySessionManager;
...
//        //设置未授权跳转的页面
        ...
        filterChainDefinitionMap.put("/**/fenlilogin","anon");
        filterChainDefinitionMap.put("/**/subLogin","anon");
        filterChainDefinitionMap.put("/**/fenlilogin.html","anon");
        filterChainDefinitionMap.put("/**/fenlimain.html","anon");
        filterChainDefinitionMap.put("/**/shirofenli/**","anon");
        filterChainDefinitionMap.put("/**/hello","anon");
        //需要登录访问的资源 , 一般将/**放在最下边
